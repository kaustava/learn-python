...
setwd("E:/DATA SCIENCE PREPERATION/EDWISOR/R_programming_working_directory")
...
#reading Excel sheet
library(xlsx)
data_excel = read.xlsx("MissingInfo-V2.xlsx", sheetIndex = 1, header = T)

#reading .txt file as dataframe
data_text = read.delim("MissingInfo-V2.txt", sep = "\t", header = F)   
